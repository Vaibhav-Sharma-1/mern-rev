    ...
    return (
        <div className="p-3 max-w-3xl mx-auto min-h-screen">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <ReactQuill theme="snow" placeholder="write " className="h-72 mb-12" required onChange={(e) => setFormData({ ...formData, content: e })} />

                <Button type="submit" gradientDuoTone="purpleToPink" disabled={publishLoading}>
                    {publishLoading ? (<><Spinner size={"sm"} /><span className="pl-3">loading...</span></>) : "Publish"}
                </Button>
